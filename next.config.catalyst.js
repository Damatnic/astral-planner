...
const nextConfig = {
  ...
  experimental: {
    ...
    // CRITICAL: Force modern bundling for smaller size
    esmExternals: 'loose',
    // CRITICAL: Enable advanced CSS optimization
    optimizeCss: true,
    // CATALYST: Optimize font loading and reduce layout shift
    optimizeServerReact: true,
    // CRITICAL: Disable in production for smaller bundles
    clientTraceMetadata: process.env.NODE_ENV === 'development' ? ['trace'] : false,
    // CRITICAL: Enable webpack build worker for faster builds
    webpackBuildWorker: true,
    // CRITICAL: Use SWC for minification (faster than Terser)
    swcMinify: true,
